 ...
 * If there are multiple answers, you may return any one of them. It is guaranteed that
 * at least one answer exists.
 */
class FairCandySwap(private val aliceSizes: IntArray, private val bobSizes: IntArray) :
    Solution<IntArray> {
    ...
    override fun getResult(): IntArray {
        ...
        val a = aliceSizes.filter { setB.contains(it - diff) }.first()
