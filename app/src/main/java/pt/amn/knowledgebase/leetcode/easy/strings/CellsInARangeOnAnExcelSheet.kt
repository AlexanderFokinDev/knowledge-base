 ...
 */
class CellsInARangeOnAnExcelSheet(private val s: String) : Solution<List<String>> {

    override fun getResult(): List<String> {

        val startRow = Integer.parseInt(s[1].toString())
        val endRow = Integer.parseInt(s[4].toString())
        val startCol = s[0]
        val endCol = s[3]
